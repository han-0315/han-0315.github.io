...
![istio-arch.svg](/assets/img/post/서비스%20매시와%20istio/2.svg)
...
![https://istio.io/latest/docs/concepts/security/](/assets/img/post/서비스%20매시와%20istio/4.svg)
...
![https://istio.io/latest/docs/ops/deployment/architecture/](/assets/img/post/서비스%20매시와%20istio/2.svg)


Envoy는 멀티 스레딩을 사용하며, 각 서비스에 대해 Listener를 통해 요청을 수신하며 실제 엔드포인트(Pod)로 라우팅한다. 


![https://www.envoyproxy.io/docs/envoy/latest/intro/life_of_a_request](/assets/img/post/서비스%20매시와%20istio/6.svg)
