...
1주차의 주제는 **Amzaon EKS 설치 및 기본 사용**이다. 사전에 제공해주신 [AWS CloudFormation](https://docs.aws.amazon.com/cloudformation/index.html)을 통해 초기인프라를 형성하고 `eksctl` 을 통해 클러스터를 배포한다. 배포 후 클러스터에 접근하여 여러 명령어를 통해 시스템을 이해하며 마무리된다.
